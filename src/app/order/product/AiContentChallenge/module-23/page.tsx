        ...
        <div className="px-6 py-12">
          <div className="mx-auto max-w-4xl">
            ...
            <div className="bg-slate-900/80 border border-slate-800 rounded-lg p-8 text-center">
              ...
              <h1 className="text-2xl font-bold text-white mb-4">Module 23 - Locked</h1>
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-xl p-8 mb-8 shadow-lg shadow-indigo-900/20">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <div className="text-blue-100 text-sm font-medium tracking-wider">MODULE 23</div>
                <h1 className="text-3xl font-bold text-white">DIGITAL PRODUCTS</h1>
              </div>
            </div>
            <p className="text-blue-100 text-lg">Using AI to write smaller guides or ebooks to sell to your audience.</p>
          </div>
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <div className="mb-8">
                <p className="text-slate-300 leading-relaxed mb-6 text-lg">
                  Welcome to Module 23. In this module, you'll master the key concepts and techniques needed to progress in your AI Content Challenge journey.
                </p>
                ...
                <div className="bg-slate-800/50 border-l-4 border-blue-500 p-6 rounded-r-lg mb-6">
                  ...
                  <p className="text-slate-300">Using AI to write smaller guides or ebooks to sell to your audience.</p>
                </div>
              </div>
