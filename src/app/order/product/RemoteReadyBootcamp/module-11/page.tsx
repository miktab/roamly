...
export default function Module11() {
  ...
  useEffect(() => {
    async function checkProgress() {
      ...
      if (progress) {
        // Module 11 has access if currentModule is >= 11
        setHasAccess(progress.currentModule >= moduleId)
        // Module 11 is completed if currentModule is > 11
          ...
          <div className="bg-gradient-to-r from-emerald-600 to-teal-600 rounded-lg p-8 mb-8">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                ...
                <h1 className="text-3xl font-bold text-white">WEBSITE & LANDING PAGES</h1>
              </div>
            </div>
            <p className="text-emerald-100 text-lg">Create professional websites that generate leads and sales</p>
          </div>
          ...
          <div className="bg-slate-800 rounded-lg p-8 mb-8">
            ...
            <div className="prose prose-invert max-w-none">
              <p className="text-slate-300 leading-relaxed mb-4">
                This module focuses on create professional websites that generate leads and sales. You'll learn practical strategies, tools, and techniques that successful remote workers use to excel in this area. The content includes step-by-step guides, real-world examples, and actionable frameworks you can implement immediately.
              </p>
              ...
              <div className="bg-slate-700/30 rounded-lg p-6 mt-8">
                ...
                <ul className="space-y-3 text-slate-300">
                  <li className="flex items-start gap-3">
                    ...
                    <span>Master the fundamentals of create professional websites that generate leads and sales</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-emerald-400 text-sm mt-1">•</span>
