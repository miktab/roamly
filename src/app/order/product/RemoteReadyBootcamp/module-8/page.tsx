        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="bg-gradient-to-r from-slate-600 to-slate-700 rounded-lg p-8 mb-8 opacity-60">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <div className="text-slate-300 text-sm">Module 8</div>
                <h1 className="text-3xl font-bold text-slate-300">PRICING STRATEGIES</h1>
              </div>
            </div>
            <p className="text-slate-300 text-lg">Master pricing psychology and value-based pricing models</p>
          </div>
            ...
            <div className="text-center">
              ...
              <div className="bg-slate-700 rounded-lg p-4">
                <p className="text-slate-300 text-sm">
                  <strong>Preview:</strong> Master the psychology of pricing and learn value-based pricing strategies that maximize your 
                  earning potential. Understand how to price your services based on value delivered rather than time spent. 
                  Explore different pricing models, anchoring techniques, and how to confidently communicate your rates to clients.
                </p>
              </div>
            </div>
          </div>
