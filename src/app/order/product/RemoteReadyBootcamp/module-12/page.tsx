...
export default function Module12() {
  ...
  useEffect(() => {
    async function checkProgress() {
      ...
      if (progress) {
        // Module 12 has access if currentModule is >= 12
        setHasAccess(progress.currentModule >= moduleId)
        // Module 12 is completed if currentModule is > 12
          ...
          <div className="bg-gradient-to-r from-emerald-600 to-teal-600 rounded-lg p-8 mb-8">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                ...
                <h1 className="text-3xl font-bold text-white">PAYMENT & BOOKING SYSTEMS</h1>
              </div>
            </div>
            <p className="text-emerald-100 text-lg">Set up seamless payment processing and client onboarding</p>
          </div>
          ...
          <div className="bg-slate-800 rounded-lg p-8 mb-8">
            ...
            <div className="prose prose-invert max-w-none">
              <p className="text-slate-300 leading-relaxed mb-4">
                This module focuses on set up seamless payment processing and client onboarding. You'll learn practical strategies, tools, and techniques that successful remote workers use to excel in this area. The content includes step-by-step guides, real-world examples, and actionable frameworks you can implement immediately.
              </p>
              ...
              <div className="bg-slate-700/30 rounded-lg p-6 mt-8">
                ...
                <ul className="space-y-3 text-slate-300">
                  <li className="flex items-start gap-3">
                    ...
                    <span>Master the fundamentals of set up seamless payment processing and client onboarding</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-emerald-400 text-sm mt-1">•</span>
