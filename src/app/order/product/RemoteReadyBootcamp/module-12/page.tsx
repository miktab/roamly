        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="bg-gradient-to-r from-slate-600 to-slate-700 rounded-lg p-8 mb-8 opacity-60">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <div className="text-slate-300 text-sm">Module 12</div>
                <h1 className="text-3xl font-bold text-slate-300">PAYMENT & BOOKING SYSTEMS</h1>
              </div>
            </div>
            <p className="text-slate-300 text-lg">Set up seamless payment processing and client onboarding</p>
          </div>
            ...
            <div className="text-center">
              ...
              <div className="bg-slate-700 rounded-lg p-4">
                <p className="text-slate-300 text-sm">
                  <strong>Preview:</strong> Implement professional payment processing and booking systems that streamline 
                  your client acquisition process. Learn to set up secure payment gateways, automated invoicing, 
                  subscription billing, and client booking systems. Master the integration of calendars, payment processors, 
                  and automated workflows that create a seamless experience from prospect to paying client.
                </p>
              </div>
            </div>
          </div>
