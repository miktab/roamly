          ...
          <div className="bg-slate-800 rounded-lg p-8 mb-8">
            ...
            <div className="prose prose-invert max-w-none">
              <p className="text-slate-300 leading-relaxed mb-4">
                This module focuses on master the remote work mindset and set your success foundation. You'll learn practical strategies, tools, and techniques that successful remote workers use to excel in this area. The content includes step-by-step guides, real-world examples, and actionable frameworks you can implement immediately.
              </p>
              ...
              <div className="bg-slate-700/30 rounded-lg p-6 mt-8">
                ...
                <ul className="space-y-3 text-slate-300">
                  <li className="flex items-start gap-3">
                    ...
                    <span>Master the fundamentals of master the remote work mindset and set your success foundation</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-emerald-400 text-sm mt-1">•</span>
