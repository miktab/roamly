...
export default function Module6() {
  ...
  useEffect(() => {
    async function checkProgress() {
      ...
      if (progress) {
        // Module 6 has access if currentModule is >= 6
        setHasAccess(progress.currentModule >= moduleId)
        // Module 6 is completed if currentModule is > 6
          ...
          <div className="bg-gradient-to-r from-emerald-600 to-teal-600 rounded-lg p-8 mb-8">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                ...
                <h1 className="text-3xl font-bold text-white">CHOOSE YOUR NICHE & PRODUCT</h1>
              </div>
            </div>
            <p className="text-emerald-100 text-lg">Select your profitable niche and define your core offering</p>
          </div>
          ...
          <div className="bg-slate-800 rounded-lg p-8 mb-8">
            ...
            <div className="prose prose-invert max-w-none">
              <p className="text-slate-300 leading-relaxed mb-4">
                This module focuses on select your profitable niche and define your core offering. You'll learn practical strategies, tools, and techniques that successful remote workers use to excel in this area. The content includes step-by-step guides, real-world examples, and actionable frameworks you can implement immediately.
              </p>
              ...
              <div className="bg-slate-700/30 rounded-lg p-6 mt-8">
                ...
                <ul className="space-y-3 text-slate-300">
                  <li className="flex items-start gap-3">
                    ...
                    <span>Master the fundamentals of select your profitable niche and define your core offering</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-emerald-400 text-sm mt-1">•</span>
