...
export default function Module10() {
  ...
  useEffect(() => {
    async function checkProgress() {
      ...
      if (progress) {
        // Module 10 has access if currentModule is >= 10
        setHasAccess(progress.currentModule >= moduleId)
        // Module 10 is completed if currentModule is > 10
      ...
      <div className="px-6 py-12">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="bg-gradient-to-r from-emerald-600 to-teal-600 rounded-lg p-8 mb-8">
            ...
            <p className="text-emerald-100 text-lg">Build compelling portfolios that convert prospects to clients</p>
          </div>
          ...
          <div className="bg-slate-800 rounded-lg p-8 mb-8">
            ...
            <div className="prose prose-invert max-w-none">
              <p className="text-slate-300 leading-relaxed mb-4">
                This module focuses on build compelling portfolios that convert prospects to clients. You'll learn practical strategies, tools, and techniques that successful remote workers use to excel in this area. The content includes step-by-step guides, real-world examples, and actionable frameworks you can implement immediately.
              </p>
              ...
              <div className="bg-slate-700/30 rounded-lg p-6 mt-8">
                ...
                <ul className="space-y-3 text-slate-300">
                  <li className="flex items-start gap-3">
                    ...
                    <span>Master the fundamentals of build compelling portfolios that convert prospects to clients</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-emerald-400 text-sm mt-1">•</span>
