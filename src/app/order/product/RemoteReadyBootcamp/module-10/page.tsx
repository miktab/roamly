        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="bg-gradient-to-r from-slate-600 to-slate-700 rounded-lg p-8 mb-8 opacity-60">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <div className="text-slate-300 text-sm">Module 10</div>
                <h1 className="text-3xl font-bold text-slate-300">PORTFOLIO & CASE STUDIES</h1>
              </div>
            </div>
            <p className="text-slate-300 text-lg">Build compelling portfolios that convert prospects to clients</p>
          </div>
            ...
            <div className="text-center">
              ...
              <div className="bg-slate-700 rounded-lg p-4">
                <p className="text-slate-300 text-sm">
                  <strong>Preview:</strong> Create a portfolio that showcases your expertise and converts visitors into clients. 
                  Learn to craft compelling case studies that highlight your problem-solving abilities, results achieved, and 
                  value delivered. Master the art of storytelling in your portfolio, including before/after transformations, 
                  client testimonials, and quantifiable outcomes that demonstrate your impact.
                </p>
              </div>
            </div>
          </div>
