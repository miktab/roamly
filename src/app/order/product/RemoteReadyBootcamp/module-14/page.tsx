        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="bg-gradient-to-r from-slate-600 to-slate-700 rounded-lg p-8 mb-8 opacity-60">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <div className="text-slate-300 text-sm">Module 14</div>
                <h1 className="text-3xl font-bold text-slate-300">CRM & CLIENT MANAGEMENT</h1>
              </div>
            </div>
            <p className="text-slate-300 text-lg">Streamline client relationships and project management</p>
          </div>
            ...
            <div className="text-center">
              ...
              <div className="bg-slate-700 rounded-lg p-4">
                <p className="text-slate-300 text-sm">
                  <strong>Preview:</strong> Implement robust CRM and client management systems to scale your remote business. 
                  Learn to track leads, manage client relationships, automate follow-ups, and streamline project delivery. 
                  Master tools and workflows for client onboarding, project management, communication tracking, 
                  and maintaining long-term client relationships that generate recurring revenue.
                </p>
              </div>
            </div>
          </div>
