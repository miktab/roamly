...
function CourseContent() {
  ...
  const productId = Number.parseInt(searchParams.get("productId") || "0", 10)
  ...
  useEffect(() => {
    if (productId) {
      fetchProduct(productId)
        .then((fetchedProduct) => {
          if (fetchedProduct.productType !== "LocationIndependenceCourse") {
            setError("This product type is not supported on this page")
            return
          }
    ...
    return (
      <div className="min-h-screen bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-lg text-gray-300">Loading course...</p>
        </div>
      </div>
    )
  }
    ...
    <div className="min-h-screen bg-gray-900 text-white">
      <div className="relative">
        ...
        <div className="hidden lg:flex min-h-screen">
          ...
          <div className="w-1/2 relative">
            <Image
              src="/products/RemoteReadyBootcamp/banner_portrait.jpg"
          ...
          <div className="w-1/2 flex items-center justify-center p-12">
            <div className="max-w-lg">
              <div className="text-right mb-8">
                <h1 className="text-4xl font-light italic text-gray-300 mb-2">Location Independence</h1>
                <h2 className="text-5xl font-bold mb-4">Course</h2>
                <div className="w-24 h-0.5 bg-red-600 ml-auto mb-6"></div>
                <h3 className="text-2xl font-semibold mb-4">Build Your Freedom-Based Business</h3>
                <p className="text-gray-300 text-lg leading-relaxed mb-8">
                  Learn the proven strategies to create a location-independent income stream. Build a sustainable business 
                  that gives you the freedom to work from anywhere in the world.
                </p>
              </div>
              ...
              <div className="text-right mb-8">
                ...
                <p className="text-sm text-gray-400 mt-3">
                  Starting at ${product.price ? product.price / 100 : 0} (billed once). 14-day money back guaranteed.
                </p>
              </div>
        ...
        <div className="lg:hidden">
          <div className="relative h-screen">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 text-center">
              <h1 className="text-3xl font-light italic text-gray-300 mb-2">Location Independence</h1>
              <h2 className="text-4xl font-bold mb-4">Course</h2>
              <h3 className="text-xl font-semibold mb-4">Build Your Freedom-Based Business</h3>
              <p className="text-gray-300 mb-6 leading-relaxed">
                Learn proven strategies to create location-independent income and work from anywhere.
              </p>
      ...
      <div className="bg-red-600 py-8">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h3 className="text-2xl font-bold mb-2">⚡ Course Enrollment Closing Soon - Limited Spots!</h3>
          <p className="text-red-100 mb-6">Only 47 spots remaining. Enroll now before it's too late.</p>
      ...
      {/* Product Ticket Component Modal */}
      {product && <ProductTicketComponent product={product} isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} />}
    </div>
  )
}

export default function LocationIndependenceCoursePage() {
  return (
    <Suspense
      fallback={
