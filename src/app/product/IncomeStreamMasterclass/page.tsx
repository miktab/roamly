...
function IncomeStreamMasterclassContent() {
  ...
  useEffect(() => {
    ...
    fetchProduct(productId)
      .then((fetchedProduct) => {
        ...
        if (fetchedProduct.productType !== "IncomeStreamMasterclass") {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-lg text-gray-600">Loading Income Stream Masterclass...</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">The Income Stream Masterclass you're looking for doesn't exist.</p>
          <Link href="/products">
            <Button>
              <ArrowLeft className="w-4 h-4 mr-2" />
              Back to Products
...
function IncomeStreamMasterclassPageContent() {
  return (
    <Suspense fallback={
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
      ...
      <IncomeStreamMasterclassContent />
    </Suspense>
  )
}

export default function IncomeStreamMasterclassPage() {
  return <IncomeStreamMasterclassPageContent />
}
